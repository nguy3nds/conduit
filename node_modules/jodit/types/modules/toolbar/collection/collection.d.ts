...
import type { IToolbarButton, IToolbarCollection, IUIButton, Nullable, IControlTypeStrong, IViewBased, ButtonsGroups } from '../../../types/';
import { UIList } from '../../../core/ui';
export declare class ToolbarCollection<T extends IViewBased = IViewBased> extends UIList<T> implements IToolbarCollection {
    /** @override */
    className(): string;
    jodit: T;
