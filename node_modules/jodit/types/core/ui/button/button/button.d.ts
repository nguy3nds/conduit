 ...
 */
import './button.less';
import type { IUIButton, IUIButtonState, IUIButtonStatePartial, IViewBased, ButtonStatus } from '../../../../types';
...
export declare function Button(jodit: IViewBased, icon: string, text: string, status?: ButtonStatus): IUIButton;
export declare function Button(jodit: IViewBased, state: IUIButtonStatePartial, status?: ButtonStatus): IUIButton;
